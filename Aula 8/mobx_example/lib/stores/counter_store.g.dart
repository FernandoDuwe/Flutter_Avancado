...
mixin _$CounterStore on _CounterStore, Store {
  Computed<bool>? _$countIsNegativeComputed;

  @override
  bool get countIsNegative =>
      (_$countIsNegativeComputed ??= Computed<bool>(() => super.countIsNegative,
              name: '_CounterStore.countIsNegative'))
          .value;
  Computed<bool>? _$countIsPositiveComputed;

  @override
  bool get countIsPositive =>
      (_$countIsPositiveComputed ??= Computed<bool>(() => super.countIsPositive,
              name: '_CounterStore.countIsPositive'))
          .value;
  ...
  String toString() {
    return '''
count: ${count},
countIsNegative: ${countIsNegative},
countIsPositive: ${countIsPositive}
    ''';
  }
}
